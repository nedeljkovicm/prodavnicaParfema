  ...
  <body>
   ...
   <?php 
    ...
    include "konekcija.php";
                $sql="SELECT * FROM parfem WHERE id=5";
     ...
     <img src="slike/YSLBlackOpium.1.jpg" style="height: 100% ">
      <img src ="slike/1.3.jpg"  style="height: 100%">
      
      <img src="slike/1.2.jpg"  style="height: 100% ">
