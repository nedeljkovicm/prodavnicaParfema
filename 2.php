  ...
  <body>
   ...
   <?php 
    ...
    include "konekcija.php";
                $sql="SELECT * FROM parfem WHERE id=2";
              ...
              <div id="slides"  style="float: left; margin-top: 110px; width: 50%; margin-right:2%; margin-bottom: 0.5em; border-radius: 10px;">  
      
     <img src="slike/Guerlain.1.jpg" style="height: 100% ">
      <img src ="slike/4.4.1.jpg"  style="height: 100%">
      
      <img src="slike/4.6.jpg"  style="height: 100% ">
