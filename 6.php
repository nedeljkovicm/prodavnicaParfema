  ...
  <body>
   ...
   <?php 
    ...
    include "konekcija.php";
                $sql="SELECT * FROM parfem WHERE id=6";
     ...
     <img src="slike/Olympea1.jpg" style="height: 100% ">
      <img src ="slike/6.3.jpg"  style="height: 90%">
      
      <img src="slike/6.4.jpg"  style="height: 90% ">
